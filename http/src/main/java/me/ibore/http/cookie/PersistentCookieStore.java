...
public class PersistentCookieStore {
    ...
    protected String encodeCookie(SerializableOkHttpCookies cookie) {
        ...
        try {
            ...
            LogUtils.log("IOException in encodeCookie" + e.getMessage());
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtils.log("IOException in decodeCookie" + e.getMessage());
        } catch (ClassNotFoundException e) {
            LogUtils.log("ClassNotFoundException in decodeCookie" + e.getMessage());
        }
